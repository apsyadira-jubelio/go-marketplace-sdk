...
func (c *TiktokClient) logRequest(req *http.Request, skipBody bool) {
	if req == nil {
		return
	}
	if req.URL != nil {
...
func (c *TiktokClient) logResponse(res *http.Response) {
	if res == nil {
		return
	}
...
func (c *TiktokClient) logBody(body *io.ReadCloser, format string) {
